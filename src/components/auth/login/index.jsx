    ...
    const onSubmit = async (e) => {
        ...
        if (!isSigningIn) {
            ...
            try {
                ...
                // Additional actions on successful login (e.g., navigate to a dashboard)
            } catch (error) {

                console.log(error.code);
                // Extract and set a user-friendly error message
                ...
                if (error.code === 'auth/user-not-found') {
                    ...
                    errorMessage = 'Login Credentials are invalid. Please try again.';
                }
